...
export default function Home() {
  return (
    ...
    <div className="flex justify-center items-center gap-2 flex-wrap">
      ...
      <Card img="/simon-hurry-W2yPIFjOcjc-unsplash.jpg" Heading="GenX: The ones who gave nothing" discription="A generation that failed to do it's job and give the next generation an enviornment to live in and to sustain for the upcoming generations" link="/articles/GenX"/>
    </div>
    </div>
